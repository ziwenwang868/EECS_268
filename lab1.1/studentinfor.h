...
class studentinfor
{
    ...
    int *studentids;//array of student id number store ids in one class
   

    public:

    void setstudentid(int *x);//passing the id number as string and int as index filling into studentids array
   ...
   void print();
    ...
    int *getstuids()const;//return the pointer to student ids
